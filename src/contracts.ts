...
import { BSCTESTNET_CONFIGS, GANACHE_CONFIGS, KOVAN_CONFIGS, NETWORK_CONFIGS, RINKEBY_CONFIGS } from './configs';
...
const ERC721_TOKENS_BY_CHAIN_ID: { [chainId: number]: string[] } = {
    ...
    [BSCTESTNET_CONFIGS.chainId]: ['0x84580f1ea9d989c71c13492d5d157712f08795d8'],
    [ROPSTEN_NETWORK_ID]: [],
};
